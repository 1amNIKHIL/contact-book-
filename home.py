...
class HomeWindow(Tk):
    def __init__(self, *args, **kwargs):
        ...
        command = self.manage_contacts_button_click, style = 'Navigation.TButton')
        self.manage_contacts_button.pack(ipady = 10, pady = 1)

        self.change_password_button = Button(self.navigation_frame, text="Change Password", style = 'Navigation.TButton',
